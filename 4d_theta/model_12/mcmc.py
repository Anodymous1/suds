...
if __name__ == "__main__":
    ...
    test_x = [np.array(pd.read_csv(f"./model_12/mass_density_x_{prof}_model_12.csv", header=None))]

    with open(f'./model_12/inference_model_12_{prof}.pkl', 'rb') as file:
    ...
    pd.DataFrame(final_samples[0]).to_csv(f"./model_12/mass_density_samples_model_12_{prof}.csv", header=None, index=None)
