...
def initialize_training(file_path_model: str,
    ...
    proposal = generate_proposal(inference, mcmc_settings)
        
    x_o = load_csv("./8d_theta/model_1/x_o.csv", "Tensor")
...
def train_model(file_path_model: str,
    ...
    for i in range(num_rounds):
        ...
        # new proposal
        proposal = generate_proposal(inference,
                                     mcmc_settings,
                                     x_o)
        
        # save model
        save_pickle(inference, f"./8d_theta/model_1/inference_r{i}.pkl")
