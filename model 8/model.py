...
theta_train = np.array(pd.read_csv(f"./model 8/training_theta_g100k_s100p.csv", header=None))
x_train = np.array(pd.read_csv(f"./model 8/training_x_g100k_s100p.csv", header=None))
...
with open(f"./model 8/inference_model_8.pkl", "wb") as handle:
