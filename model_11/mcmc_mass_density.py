...
if __name__ == "__main__":
    ...
    x_mass_density = np.array(pd.read_csv(f"./model_14/mass_density_x_{prof}_model_14.csv", header=None))
    ...
    pd.DataFrame(final_samples[0]).to_csv(f"./model_14/mass_density_samples_model_14_{prof}_test.csv", header=None, index=None)
